...
<div class="d-flex">
    ...
    <div class="content">
        <h2 class="page-title">Thông Tin Bác sĩ</h2>
        ...
        <div class="dashboard-container">
            <div class="employee-card">
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ $doctor->HoTen }}</div>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ $doctor->ChuyenMon }}</div>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ $doctor->SDT }}</div>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ number_format($doctor->LuongTheoGio, 0, ',', '.') }} VND</div>
                    </div>
                </div>
            </div>
            ...
            <div class="schedule-section">
                <div class="schedule-header">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('doctor.schedule', ['id' => session('manage_id'), 'type' => 'week']) }}"
                           class="btn btn-schedule {{ request('type') == 'week' ? 'active' : '' }}">
                            Xem theo tuần
                        </a>
                        <a href="{{ route('doctor.schedule', ['id' => session('manage_id'), 'type' => 'month']) }}"
                            ...
                            @foreach($schedule as $day)
                                    <tr>
                                        ...
                                        @if($day['status'] === 'working')
                                            <td>
                                                @if($day['type'] === 'assignment')
                                                    {{ $day['details']->LoaiCongViec }}
                                                @elseif($day['type'] === 'appointment')
                                                    Khám bệnh
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="schedule-details">
                                                    ...
                                                    @elseif($day['type'] === 'appointment')
                                                        <div><strong>Giờ khám:</strong> {{ \Carbon\Carbon::parse($day['details']->GioKham)->format('H:i') }}</div>
                                                        <div><strong>Tên thú cưng:</strong> {{ $day['details']->TenThuCung ?? 'N/A' }}</div>
                                                    @endif
                                                </div>
                                            </td>
                                        @else
