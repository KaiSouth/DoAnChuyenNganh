    ...
    <!-- Topbar End -->
     ...
     <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
           <!-- Thay thế phần Navbar hiện tại bằng đoạn sau -->
            <div class="navbar-nav ms-auto py-0">
                ...
                @if(session()->has('user_id'))
                    ...
                    <a href="{{ route('logout') }}" class="nav-item nav-link">ĐĂNG XUẤT<i class="fas fa-sign-out-alt"></i> </a>

                @else
                    <a href="{{ route('login.form') }}" class="nav-item nav-link ">ĐĂNG NHẬP <i class="fas fa-sign-in-alt"></i></a>
                @endif



                <a href="{{ route('cart') }}" class="nav-item nav-link">GIỎ HÀNG <i class="fas fa-shopping-cart"></i></a>
            </div>
